...
internal class ObtenerPeoresReseñasPorCursoQueryHandler(IEncuestasRepository encuestasRepository) : IQueryHandler<ObtenerPeoresReseñasPorCursoQuery, Result>
{
    public async Task<Result> Handle(ObtenerPeoresReseñasPorCursoQuery request, CancellationToken cancellationToken)
    {
        ...
        List<Encuesta> ordenadas = filtradas.OrderBy(e => e.CalificacionCurso.Valor)
